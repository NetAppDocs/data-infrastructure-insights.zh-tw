...
[role="lead"]
在滿足最低作業系統、CPU、記憶體和磁碟空間要求的專用伺服器上部署 Workload Security Agent，以確保最佳的監控和威脅偵測效能。本指南詳細說明了link:task_cs_add_agent.html["安裝 Workload Security Agent"]前所需的硬體和網路要求，包括支援的 Linux 發行版、網路連接規則和系統容量規劃指南。
