...
如果您是第一次登入Data Infrastructure Insights，請閱讀有關Data Infrastructure Insights所能提供的一切信息，當您_準備好開始使用_時，點擊*申請試用*並填寫您的資訊。

作為試用租用戶設定的一部分，您將選擇託管租用戶的區域，以及您希望將租用戶部署在 AWS 還是 Azure 上。
...
租戶建立完成後，您可以隨時登入NetApp BlueXP Portal 並導航至以下位置： link:https://services.cloud.netapp.com["雲端服務"] 頁面並選擇「前往Data Infrastructure Insights」。
