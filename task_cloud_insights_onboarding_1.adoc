...
若要開始使用 NetApp 的雲端服務，請前往link:https://cloud.netapp.com["* NetApp BlueXP*"^]並按一下 * 開始使用 * 。
...
擁有 NetApp BlueXP  帳戶後，只要在入口網站頁面上選擇 * 登入 * 即可link:https://cloud.netapp.com["* NetApp BlueXP*"^]。
...
第一次登入新環境時，系統會引導您設定至link:task_getting_started_with_cloud_insights.html["*開始收集資料*"]。
