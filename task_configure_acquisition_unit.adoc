...
如果您發現您的 AU 在嘗試連線至 DII 時遭到封鎖，請嘗試將這些端點新增至您的 Proxy：
...
您可能需要的特定 NetApp Console Proxy 端點列於 link:https://docs.netapp.com/us-en/console-setup-admin/reference-networking-saas-console-previous.html#update-endpoint-list["主控台設定管理員"] 文件中。
